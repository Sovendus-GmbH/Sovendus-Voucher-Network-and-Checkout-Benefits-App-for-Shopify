...
${errorInfo.componentStack}`);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/currency.mjs
  ...
  // extensions/sovendus-banner/src/Checkout.tsx
  var import_react19 = __toESM(require_react());

  // extensions/sovendus-banner/src/CheckoutBenefits.tsx
  ...
  function CheckoutBenefits({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { padding: "none", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { level: 1, children: "Welches Dankesch\xF6n m\xF6chten Sie als Belohnung?" }),
      checkoutBenefits.recommendations.map((recommendation, index) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
  ...
  function CheckoutBenefitsOffer({
    ...
    const teaserImage = recommendation.images.find(
      (image) => image.contentName === "teaserImage"
    );
    const heading = recommendation.texts.find(
      (text) => text.contentName === "teaserTitle"
    );
    const content = recommendation.texts.find((text) => text.contentName === "productListOfferAdvantages").content.split("\n");
      ...
      InlineLayout2,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Image2,
            {
              source: "https://assets.sovendus.com/images/template/" + teaserImage.contentName + "/" + teaserImage.name + "." + teaserImage.fileExtension
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { padding: "none", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { level: 2, children: heading.content }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CheckoutBenefitsProductAdvantages, { content }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              Link2,
              {
                external: true,
                to: "https://press-list-api.sovendus.com/external?sessionUuid=" + sessionUuid + "&productOfferId=" + recommendation.productOfferId + "&agentId=" + recommendation.agentId + "&tm=" + tm + "&orderRouteId=" + recommendation.orderRouteId + "&gender=null&country=" + country + "&zipCode=" + zipCode + "&yearOfBirth=null&initialTm=" + initialTm + "&openNativeBrowser=true",
                children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { children: "Hier klicken \xBB" })
              }
            )
          ] })
        ]
  ...
  function CheckoutBenefitsProductAdvantages({ content }) {
    return content.map((line, index) => {
      if (line.includes("**")) {
        return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ListItem2, { children: line.split("**").join("").replace("* ", "") }, index);
      }
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ListItem2, { children: line.replace("* ", "") }, index);
    });
  }

  // extensions/sovendus-banner/src/VoucherNetwork.tsx
  var import_jsx_runtime5 = __toESM(require_jsx_runtime());
  function SovendusImageBanner({
    bannerData
  }) {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Link2, { external: true, to: bannerData.bannerUrl, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Image2, { source: bannerData.bannerImageUrl }) }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(DataUsageText, { bannerData })
    ] });
  }
  function SovendusNativeBanner({
    bannerData
  }) {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Heading2, { level: 1, children: bannerData.title }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
        InlineLayout2,
        {
          ...
          blockAlignment: "center",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Image2, { source: bannerData.imageUrl }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { children: bannerData.description.map(
              (textItem, index) => textItem.bold ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { emphasis: "bold", children: textItem.text }, index) : textItem.text
            ) })
          ]
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Link2, { external: true, to: bannerData.bannerUrl, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Button2, { children: bannerData.selectVoucherText }) }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(DataUsageText, { bannerData })
    ] });
  }
  function DataUsageText({
    ...
    var _a;
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { size: "extraSmall", children: (_a = bannerData.dataUsageText) == null ? void 0 : _a.map((textBlock, index) => {
      if (textBlock.url) {
        return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Link2, { to: textBlock.url, children: textBlock.text }, index);
      }
      return textBlock.text;
    }) });
  }

  // extensions/sovendus-banner/src/api.ts
  function useGetTrafficNumbers(addressData) {
    var _a, _b, _c, _d, _e;
    const metafields = useAppMetafields({
      namespace: "sovendus_settings",
      key: "sovendus_settings_values"
    });
    const sovendusSettings = ((_b = (_a = metafields == null ? void 0 : metafields[0]) == null ? void 0 : _a.metafield) == null ? void 0 : _b.value) ? JSON.parse(metafields[0].metafield.value) : {};
  ...
  var newBannerData = {
    ...
    checkoutBenefits: {
      recommendations: [
        {
          ...
          isExternal: false,
          productName: "Geb\xFChrenfrei Mastercard Gold",
          displayName: "Geb\xFChrenfrei Mastercard Gold",
          texts: [
            {
              content: "Geb\xFChrenfrei Mastercard Gold +  50 \u20AC Startguthaben oder 50 \u20AC Tankgutschein gratis",
              contentName: "teaserTitle"
            },
            {
              content: "* 0,- \u20AC Jahresgeb\xFChr\n* Kein Kontowechsel notwendig\n* **0 \u20AC Auslandseinsatzgeb\xFChr**\n* Umfassende Reiseversicherung\n* **Ihr sicherer Begleiter f\xFCr die n\xE4chste Reise**",
        ...
        },
        {
          ...
          texts: [
            ...
            {
              content: "* Athletisches Design\n* Ultraschnelles Laden\xB9\n* Optimierte Performance",
              contentName: "productListOfferAdvantages"
            }
          ],
          images: [
        ...
        },
        {
          ...
          texts: [
            ...
            {
              content: "* Jetzt kostenlos testen\n* Belieferung endet automatisch\n* Keine K\xFCndigung notwendig",
              contentName: "productListOfferAdvantages"
            }
          ],
          images: [
        ...
        },
        {
          ...
          texts: [
            {
              content: "Registrieren und bis zu 300 \u20AC Amazon.de Gutscheine sichern",
              contentName: "teaserTitle"
            },
            {
              content: "* Manage deine Versicherungen digital & dauerhaft kostenlos\n* Bessere Tarifvorschl\xE4ge aus dem ganzen Markt\n* Vertr\xE4ge digitalisieren und je Versicherung einen 15 \u20AC Amazon.de Gutschein erhalten",
              contentName: "productListOfferAdvantages"
            }
          ],
          images: [
        ...
        },
        {
          ...
          texts: [
            ...
            {
              content: "* Moderne Hybrid-L\xF6sungen \n* Bequemes und effizientes Ladeerlebnis \n* Technologie f\xFCr deine Sicherheit",
              contentName: "productListOfferAdvantages"
            }
          ],
          images: [
        ...
        },
        {
          ...
          texts: [
            ...
            {
              content: "* 2 Ausgaben f\xFCr nur 4,90 \u20AC\n* 64 % sparen\n* Portofreie Lieferung",
              contentName: "productListOfferAdvantages"
            }
          ],
          images: [
      ...
      tm: {
        shopId: 5364,
        shopCss: true,
        shopLogo: "https://assets.sovendus.com/images/shop/5364/logo.png?41d8222b"
      },
      hadZip: true
    }
  };
  ...
  var thankYouBlock = reactExtension("purchase.thank-you.block.render", () => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ThankYouSovendusBanner, {}));
  var orderDetailsBlock = reactExtension(
    "customer-account.order-status.block.render",
    () => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(OrderStatusSovendusBanner, {})
  );
  function ThankYouSovendusBanner() {
    const api = useApi();
    const orderConfirmationNumber = api.orderConfirmation.current.number;
    return orderConfirmationNumber !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SovendusBanner, { orderConfirmationNumber });
  }
  function OrderStatusSovendusBanner() {
    const api = useApi();
    const orderConfirmationNumber = api.order.current.confirmationNumber;
    return orderConfirmationNumber !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SovendusBanner, { orderConfirmationNumber });
  }
  function SovendusBanner({
    orderConfirmationNumber
  }) {
    const [bannerData, setBannerData] = (0, import_react19.useState)();
    const currency = useCurrency();
    const addressData = useShippingAddress();
    const [isEnabled, trafficSourceNumber, trafficMediumNumber] = useGetTrafficNumbers(addressData);
    const voucherCodes = useDiscountCodes();
    const voucherCode = (voucherCodes == null ? void 0 : voucherCodes.length) > 0 ? voucherCodes[0].code : "";
...
//# sourceMappingURL=sovendus-banner.js.map
