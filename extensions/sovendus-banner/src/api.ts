...
export function getBannerData({
  ...
  const searchParams: BannerRequestData = {
    trafficSourceNumber: trafficSourceNumber,
    trafficMediumNumber: trafficMediumNumber,
    ...(orderConfirmationNumber && { orderId: orderConfirmationNumber }),
    ...(netOrderValue && { orderValue: String(netOrderValue) }),
    ...(currency.isoCode && { orderCurrency: currency.isoCode }),
    ...(voucherCode && { usedCouponCode: voucherCode }),
    ...
    ...(email && { email: email }),
    ...(phone && { phone: phone }),
    ...(addressData.countryCode && { country: addressData.countryCode }),
  };
